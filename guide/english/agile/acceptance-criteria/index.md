...
The Acceptance Criteria tells the Delivery Team how the code should behave, and is the set of requirements that were agreed upon by the Product Owner and Delivery Team. Avoid writing the **"How"** of the User Story; keep to the **"What"**.
